...
import profilepic from "./assets/squirrel.png";
...
export function DashboardNav() {
  ...
  useEffect(() => {
    ...
    if (state && state.user) {
      setUser({
        ...state.user,
        profilePic: state.user.profilePic || profilepic,
      });
    }
  }, [location]);
    ...
    <>
      <nav className="bg-white border-gray-200 dark:bg-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          >
            <img src={logo} className="h-8 animate-pulse" alt="VentureVue" />
            ...
            <div className="relative">
              ...
              >
                ...
                <img
                  ...
                  src={user ? user.profilePic : profilepic}
                  alt="user photo"
                />
              </button>
              {isDropdownOpen && (
                  ...
                  <div class="p-4 md:p-5">
                    <form class="space-y-4" action="#">
                      <div>
                        ...
                        <select
                          onChange={checkIfSector}
                          id="select_dropdown"
                          name="dropdown"
                          class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-gray-400"
                          type="button"
                          required
                        >
                          Select..
                          ...
                          <option id="select1" value="select">
                            Select
                          </option>
                          <option id="sector" value="sector">
                            Sector
                          </option>
                      ...
                      <div>
                        ...
                        >
                          ...
                          <option id="select2" value="select">
                            Select
                          </option>
                          <option id="automotive" value="automotive">
                            Automotive
                          </option>
                          <option id="energy" value="energy">
                            Energy
                          </option>
                          ...
                          <option id="dining" value="dining">
                            Dining
                          </option>
                          <option id="healthcare" value="healthcare">
                            Healthcare
                          </option>
                          <option id="real_estate" value="real_estate">
                            Real Estate
                          </option>
                          <option id="legal_services" value="legal_services">
                            Legal Services
                          </option>
                          <option id="retail" value="retail">
                            Retail
                          </option>
                          <option id="technology" value="technology">
                            Technology
                          </option>
                          <option id="tourism" value="tourism">
                            Tourism
                          </option>
                        </select>
                      </div>
                      <div>
                        ...
                        >
                          ...
                          <option id="select3" value="select">
                            Select
                          </option>
                          <option id="andhra_pradesh" value="andhra_pradesh">
                            Andhra Pradesh
                          </option>
                          <option id="andaman_nicobar" value="andaman_nicobar">
                            Andaman and Nicobar Islands
                          </option>
                          <option id="arunachal" value="arunachal">
                            Arunachal Pradesh
                          </option>
                          ...
                          <option id="chattisgarh" value="chattisgarh">
                            Chhattisgarh
                          </option>
                          <option id="dadra" value="dadra">
                          ...
                          <option id="himachal" value="himachal">
                            Himachal Pradesh
                          </option>
                          ...
                          <option id="ladakh" value="ladakh">
                            Ladakh
                          </option>
                          <option id="lakshadweep" value="lakshadweep">
                            Lakshadweep
                          </option>
                          ...
                          <option id="puducherry" value="puducherry">
                            Puducherry
                          </option>
                          ...
                          <option id="tamil_nadu" value="tamil_nadu">
                            Tamil Nadu
                          </option>
                          ...
                          <option id="west_bengal" value="west_bengal">
                            West Bengal
                          </option>
                        </select>
                      </div>
